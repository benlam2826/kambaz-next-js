            ...
            <Table striped>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="wd-login-id">002211THO</td>
                        <td className="wd-section">S101</td>
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-10-04</td>
                        <td className="wd-total-activity">06:12:18</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td className="wd-login-id">00998877SR</td>
                        <td className="wd-section">S101</td>
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-10-05</td>
                        <td className="wd-total-activity">07:08:09</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-10-01</td>
                        <td className="wd-total-activity">10:20:30</td>
                    </tr>
                </tbody>
            </Table>
        </div>
